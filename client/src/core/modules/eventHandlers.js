function addButtonHoverSounds() {
  // Audio functionality has been removed per user request
}

// Export function to allow adding hover sounds to dynamically created buttons
export function addHoverSoundsToNewButtons() {
...
export function initializeEventHandlers() {
    ...
    button.addEventListener("click", () => {
      switch (text) {
        ...
        case "Settings":
          ...
          break;
        case "Main Menu":
          if (window.hidePauseAndGoToMainMenu)
            window.hidePauseAndGoToMainMenu();
          break;
        case "Back":
          if (window.togglePause) window.togglePause();
          break;
  ...
  settingsButtons.forEach((button) => {
    if (button.classList.contains("theme-button")) {
      ...
      button.classList.contains("breadcrumb")
    ) {
      button.addEventListener("click", () => {
  ...
  // Button hover sounds have been removed per user request
}
